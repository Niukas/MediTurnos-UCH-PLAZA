<nav class="bg-white border-b border-lightblue/50 px-6 sm:px-10 h-16 flex items-center justify-between sticky top-0 z-[100]">
    <div class="flex items-center gap-2 font-serif text-charcoal text-xl">
        ...
        <span class="font-sans text-sm font-medium text-slate ml-3 border-l border-gray-200 pl-3 hidden sm:inline-block">Hola, <?= $_SESSION['usuario_nombre'] ?></span>
    </div>
    <div class="flex items-center gap-4 sm:gap-6">
        <a href="Panel.php" class="text-[0.85rem] font-medium text-slate uppercase tracking-wider hover:text-charcoal transition-colors hidden md:inline-block">Mis turnos</a>
        <a href="SacarTurno.php" class="text-[0.85rem] font-medium text-slate uppercase tracking-wider hover:text-charcoal transition-colors hidden md:inline-block">Sacar turno</a>
